...
--
CREATE DATABASE `autojavitas` DEFAULT CHARACTER SET utf8 COLLATE utf8_hungarian_ci;
USE `autojavitas`;

-- --------------------------------------------------------

--
-- Tábla szerkezet: `autosok`
--

CREATE TABLE IF NOT EXISTS `autosok` (
  `autos_id` int(5) NOT NULL AUTO_INCREMENT,
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci AUTO_INCREMENT=51 ;
...
CREATE TABLE IF NOT EXISTS `javitasok` (
  `javitas_id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci AUTO_INCREMENT=101 ;
...
CREATE TABLE IF NOT EXISTS `szerelok` (
  `szerelo_id` int(5) NOT NULL AUTO_INCREMENT,
